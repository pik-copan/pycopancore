...
of those processes that are important for the mid- to long-term fate of nature and humanity on a global scale,
to gain a better understanding of their feedbacks, important parameters, and possible emergent dynamics,
and to help answering research questions about possibilities of sustainable management and policy.**

Since the global system consists of entities and processes of quite different type 
-- natural, social-metabolic/economic, cultural, etc. --
...
such as ordinary differential equations, algebraic equations, discrete-time stochastic processes, agent-based modeling, complex networks, etc.
...
in which researchers and developers from the World-Earth modeling community can collaboratively
design and implement model components and then use those to compose and study specific World-Earth models for specific research questions.
