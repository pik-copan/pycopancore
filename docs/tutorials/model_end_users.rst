...
:doc:`API documentation <../api/pycopancore/pycopancore.models>` of the model at hand.
...
:doc:`seven dwarfs model <../api/pycopancore/pycopancore.model_components.seven_dwarfs>`.
...
:doc:`API documentation <../api/pycopancore/pycopancore.model_components.seven_dwarfs>`.
::
