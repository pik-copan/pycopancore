...
class Dimension(object):
    ...
    def __init__(
        ...
        if is_base:
            ...
            self.desc = (
                "\n\n".join(
                    [dim.name + ": " + dim.desc for dim in exponents.keys()]
                )
                if desc is None
                else desc
            )
...
nondim = Dimension(
    name="non-dimensional", desc="non-dimensional", exponents={}, is_base=False
)
