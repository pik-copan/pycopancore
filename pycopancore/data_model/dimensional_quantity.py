...
class DimensionalQuantity():
    ...
    def reduce(self):
        ...
        return self._multiple * self._unit.factor if self._dimension == nondim else self
    
    def __pow__(self, power):
        return DimensionalQuantity(self._multiple**power, self._unit**power).reduce()
    ...
    def __add__(self, other):
        ...
        return DimensionalQuantity(self._multiple + other._multiple*other._unit.factor/self._unit.factor, self._unit).reduce()
    ...
    def __mul__(self, other):
        if isinstance(other, DimensionalQuantity):
            return DimensionalQuantity(self._multiple * other._multiple, self._unit * other._unit).reduce()
        else:
            return DimensionalQuantity(self._multiple * other, self._unit).reduce()
