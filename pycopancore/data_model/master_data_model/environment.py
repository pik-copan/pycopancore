...
class Environment:
    ...
    land_area = Variable("land area",
                         "",
                         unit=DimensionsAndUnits.square_kilometers,
    ...
    atmospheric_carbon = Variable("atmospheric carbon stock",
                                  ...
                                  unit=DimensionsAndUnits.gigatonnes_carbon,
    ...
    surface_air_temperature = \
        Variable("surface air temperature",
                 ...
                 unit=DimensionsAndUnits.kelvins,
    ...
    ocean_atmosphere_diffusion_coefficient = \
        Variable("ocean-atmosphere diffusion coefficient", "",
                 unit=DimensionsAndUnits.years**-1,
                 lower_bound=0,
                 default=0.016)
    ...
    photosynthesis_carbon_flow = \
        Variable("photosynthesis carbon flow", "",
                 ...
                 unit = DimensionsAndUnits.gigatonnes_carbon / DimensionsAndUnits.years,
                 is_extensive=True, lower_bound=0, default=0)
