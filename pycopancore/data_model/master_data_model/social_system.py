...
class SocialSystem:
    ...
    protected_terrestrial_carbon_share = (
        MET.protected_terrestrial_carbon_share.copy()
    )
    ...
    has_renewable_subsidy = Variable(
        "has renewable subsidy",
        "whether a subsidy for renewables is in force",
        scale="ordinal",
        levels=[False, True],
        default=False,
    )
    has_emissions_tax = Variable(
        "has emissions tax",
