...
from pycopancore.private._simple_expressions import unknown, unset
...
class Variable(Symbol):
    ...
    (https://tntcat.iiasa.ac.at/ADVANCEWP1DB/static/download/Diagnostics_template_2015-08-12.xlsx)"""  # noqa: E501
    CETS = None
    ...
    def _check_valid(self, v):
        ...
        if v is None:
            ...
            # FIXME: the following was commented out since it does not accept 0
            # as float:
            #            if self.datatype is not None:
    ...
    def is_valid(self, value):
        ...
        return self._check_valid(value)
