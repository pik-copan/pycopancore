...
class Environment(object):
    ...
    worlds = SetVariable(
        "worlds", "Set of Worlds governed by this Environment", readonly=True
    )
...
class Metabolism(object):
    ...
    # read-only attributes storing redundant information:
    worlds = SetVariable(
        "worlds", "Set of Worlds governed by this Metabolism", readonly=True
    )
...
class World(object, metaclass=_MixinType):
    ...
    # the metaclass is needed to allow for intercepting class attribute
    # calls when constructing DotConstructs like
    # World.environment.geographic_network. similarly for the other entity
    # types.
...
class SocialSystem(object, metaclass=_MixinType):
    ...
    cells = SetVariable(
        "cells", "set of direct and indirect territory Cells", readonly=True
    )
...
class Cell(object, metaclass=_MixinType):
    ...
    # other variables:
    location = Variable(
        "location", "pair of coordinates?", allow_none=True, default=None
...
class Group(object, metaclass=_MixinType):
    ...
    #                                         allow_none=True)  # type is
    #                                         Group, hence it can only be
    #                                         specified after class Group is
    #                                         defined, see below
