...
class World (W):
    ...
    r = ((
            1 + E.NPP_enhancement_340_to_680_ppm 
                * (sp.log(E.const_680_ppmvCO2 / W.preindustrial_carbon_stock_atmospheric_CO2)) 
         ) / (
            1 + E.NPP_enhancement_340_to_680_ppm 
                * (sp.log(E.const_340_ppmvCO2 / W.preindustrial_carbon_stock_atmospheric_CO2))
        ))
    """(A17)"""
    
    b = ((
            (E.const_680_ppmvCO2 - E.NPP_zero_carbon_stock_atmospheric_CO2) 
            - r * (E.const_340_ppmvCO2 - E.NPP_zero_carbon_stock_atmospheric_CO2)
         ) / (
             (r - 1) 
             * (E.const_680_ppmvCO2 - E.NPP_zero_carbon_stock_atmospheric_CO2) 
             * (E.const_340_ppmvCO2 - E.NPP_zero_carbon_stock_atmospheric_CO2)
        ))
    """(A18)"""
    ...
    processes = [
        ...
        ODE ("Mass balance for the plant box",
             ...
             [E.NPP_fraction_to_living_plants * W.carbon_flow_net_primary_production
              ...
              - W.carbon_flow_gross_deforestation_living_plants],
