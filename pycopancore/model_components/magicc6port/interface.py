...
class World (object):
    ...
    preind_cstock_atmo_CO2 = Variable(
        ...
        symbol="C0", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    preind_cflow_net_primary_prod = Variable(
        ...
        symbol="NPP0", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    initial_cflow_litter_prod = Variable(
        ...
        symbol="L0", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    cflow_CO2_emiss_fossil_industrial = Variable(
        ...
        symbol="Efoss", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    cflow_emiss_flow_methane_fuel = Variable(
        ...
        symbol="EfCH4", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    cstock_atmo_CO2 = Variable(
        ...
        symbol="C", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    cflow_uptake_ocean = Variable(
        ...
        symbol="Focn", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, is_extensive=True, default=0)
    ...
    cflow_uptake_biosphere = Variable(
        ...
        symbol="Fterr", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, is_extensive=True, default=0)
    ...
    cstock_plants = Variable(
        ...
        symbol="P", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC, strict_lower_bound=0, is_extensive=True)

    cstock_detritus = Variable(
        "Detritus", "",  
        symbol="H", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC, strict_lower_bound=0, is_extensive=True)

    cstock_soils = Variable(
        "Organic matter in soils", "",  
        symbol="S", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC, strict_lower_bound=0, is_extensive=True)
    ...
    cflow_net_primary_prod = Variable(
        ...
        symbol="NPP", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
    ...
    cflow_CO2_emiss_human_biosphere = Variable(
        ...
        symbol="Elu", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, is_extensive=True, default=0)

    cflow_het_respiration = Variable(
        "Heterotrophic_respiration", "",  
        symbol="R", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
    ...
    turnover_time_plants = Variable(
        ...
        symbol="τP", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    cflow_detritus_oxid = Variable(
        ...
        symbol="QA", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)

    cflow_detritus_to_soil = Variable(
        "Detritus sink to the soils", "",  
        symbol="QS", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
    ...
    cflow_detritus_landuse = Variable(
        ...
        symbol="DHlu", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, is_extensive=True, default=0)
    # TODO: verify this is not exogenous!

    cflow_soils_landuse = Variable(
        "Soils sink to the atmosphere due to landuse", "",  
        symbol="DSlu", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, is_extensive=True, default=0)
    # TODO: verify this is not exogenous!
    ...
    cflow_regrowth_plants = Variable(
        ...
        symbol="GP", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
        
    cflow_regrowth_detritus = Variable(
        "Regrowth of detritus", "",  
        symbol="GH", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
        
    cflow_regrowth_soils = Variable(
        "Regrowth of soils", "",  
        symbol="GS", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=GtC/yr, lower_bound=0, is_extensive=True, default=0)
    ...
    effective_carbon_fertil_factor = Variable(
        ...
        symbol="βeff", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    """
     = Variable(
        "", "",  
        symbol="", CF=None, AMIP=None, codes={"MAGICC":None},
...
class Environment (object):
    ...
    NPP_zero_cstock_atmo_CO2 = Variable(
        ...
        symbol="Cb", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    litter_fraction_to_detritus = Variable(
        ...
        symbol="φH", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    terrestrial_carbon_fraction_not_regrowing = Variable(
        ...
        symbol="ψ", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    fraction_net_landuse_emiss_plants = Variable(
        ...
        symbol="dP", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=unity, lower_bound=0, upper_bound=1, is_extensive=True, default=0)
    ...
    fraction_net_landuse_emiss_detritus = Variable(
        ...
        symbol="dH", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=unity, lower_bound=0, upper_bound=1, is_extensive=True, default=0)

    fertil_parameter = Variable(
        "Fertilization parameter", "",  
        symbol="βm", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    NPP_enhancement_340_to_680_ppm = Variable(
        ...
        symbol="βs", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=unity, lower_bound=0, is_extensive=False, default=0)
    ...
    litter_fraction_to_soils = Variable(
        ...
        symbol="φS", CF=None, AMIP=None, codes={"MAGICC":None},
    ...
    fraction_net_landuse_emiss_soils = Variable(
        ...
        symbol="dS", CF=None, AMIP=None, codes={"MAGICC":None},
        unit=unity, lower_bound=0, upper_bound=1, is_extensive=True, default=0)
