...
from ..model_components import BBC as BBC
...
class World(base.World, BBC.World):
    """World entity type."""
    pass
...
# TODO: list all mixin classes needed:
class Environment(BBC.Environment, base.Environment):
    """Environment process taxon."""
    pass


# TODO: list all mixin classes needed:
class Metabolism(BBC.Metabolism, base.Metabolism):
...
# TODO: list all mixin classes needed:
class Culture(BBC.Culture, base.Culture):
...
class Model(BBC.Model,
            base.Model):
    """Class representing the whole model."""

    name = "BBC"
    """Name of the model"""
    description = "model foc analysing interactions oc human Behaviour, Biosphere and Climate"
    """Longer description"""
