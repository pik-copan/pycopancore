...
class _MixinType(type):
    ...
    def __getattribute__(cls, name):
        ...
        if name in aggregation_names:
            ...
            #            print("new aggregation dot construct",dc,"at",cls,
            #            "with aggregation",name)
            return dc
...
class _Mixin(object, metaclass=_MixinType):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        try:
            ...
            #            print("instantiating a", cls._composed_class, args,
            #            kwargs)
    ...
    def assert_valid(
        self,
    ):  # TODO: rename to "validate" when adding code that sets unset vars
        # to default?
