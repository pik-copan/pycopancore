...
def label(e):
    try: # if individual
        cell = e.cell
        soc = cell.social_system
        return str(soc._uid)+"."+str(cell._uid)+"."+str(e._uid)
    except:
        try: # if cell
            soc = e.social_system
            return str(soc._uid)+"."+str(e._uid)
        except: # social system or world
            return str(e._uid)
            
from pickle import dump
tosave = {
          v.owning_class.__name__ + "."
          + v.codename: {label(e): traj[v][e]
