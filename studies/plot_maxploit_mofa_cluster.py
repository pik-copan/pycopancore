...
from studies.plotting_tools.plot_maxploit_functions_cluster import phase_transition
import studies.plotting_tools.plot_maxploit_functions_cluster as pmf
...
# pmf.phase_transition(data, parameter_name_list, parameter_dict, parameter_list, "descriptive_majority_threshold", last_timestep, variables_2, SAVE_PATH)
