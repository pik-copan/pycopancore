...
class TestBaseComponents:
    ...
    def test_base_world(self):
        ...
        from pycopancore.model_components.base.implementation.world import World
        world = World()
        assert world is not None
    ...
    #     from pycopancore.model_components.base.implementation.cell import Cell
    #     cell = Cell()
    #     assert cell is not None
    ...
    #     from pycopancore.model_components.base.implementation.individual import Individual
    #     individual = Individual()
    #     assert individual is not None
...
class TestSevenDwarfsComponents:
    ...
    def test_seven_dwarfs_world(self):
        ...
        from pycopancore.model_components.seven_dwarfs.implementation.world import World
        world = World()
        assert world is not None
    ...
    #     from pycopancore.model_components.seven_dwarfs.implementation.cell import Cell
    #     cell = Cell()
    #     assert cell is not None
    ...
    #     from pycopancore.model_components.seven_dwarfs.implementation.individual import Individual
    #     individual = Individual()
    #     assert individual is not None
