...
class TestAbstractComponents:
    ...
    #     from pycopancore.model_components.abstract.environment import Environment
    ...
    #     from pycopancore.model_components.abstract.metabolism import Metabolism
    ...
    def test_abstract_social_system(self):
        ...
        from pycopancore.model_components.abstract.social_system import SocialSystem
...
class TestDataModelIntegration:
    ...
    # TODO: Fix Dimension class - name property returns None, blocking integration test
